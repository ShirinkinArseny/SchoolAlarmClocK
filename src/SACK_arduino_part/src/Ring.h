...
/*
  ...
  Первые 2 бита звонка обозначают длительность.
  ...
  Таким образом мы храним 2 байта на звонок + колчиство_дней байт ссылок на звонок. 
   ...
   ...  |     ...
   512  |---  ПУСТО
   513  |     первый байт первого звонка
   514  |     второй байт первого звонка
   515  |     первый байт второго звонка
   516  |     второй байт второго звонка
   517  |     первый байт третьего звонка
   518  |     второй байт третьего звонка
   ...  |     ...
   1023  ---
*/
  ...
  class Ring {
      public:    
          ...
          */
          ...
          /*
          Получаем строковое человекопонятное время
